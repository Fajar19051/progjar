...
alldata['2']=dict(nomor=2, nama="m. syaifuddin", posisi="bek kiri")
alldata['3']=dict(nomor=3, nama="arif satria", posisi="bek tengah kiri")
alldata['4']=dict(nomor=4, nama="hansamu", posisi="bek tengah kanan")
alldata['5']=dict(nomor=5, nama="abu rizal", posisi="bek kanan")
alldata['6']=dict(nomor=6, nama="makan konate", posisi="gelandang kiri")
alldata['7']=dict(nomor=7, nama="m. hidayar", posisi="gelandang tengah")
alldata['8']=dict(nomor=8, nama="aryn williams", posisi="gelandang kanan")
alldata['9']=dict(nomor=9, nama="irfan jaya", posisi="striker kiri")
alldata['10']=dict(nomor=10, nama="david da silva", posisi="striker tengah")
alldata['11']=dict(nomor=11, nama="mahmoud eid", posisi="striker kanan")
